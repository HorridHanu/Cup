...
def print_cow():
    print("\n#\t#\t#####\t#\t #\t#\t#"
          ...
          "\n#\t#\t#\t#\t#    #\t#####"
          "\n#############################")
    print(28 * " " + "[ HorridHanu | https://github.com/HorridHanu/]\r\n")


def version():
    """Display version"""

    print("\r\n	\033[1;31m[ cup.py ]  " + __version__ + "\033[1;m\r\n")
...
def improve_dictionary(file_to_open):
    ...
    print_to_file(file_to_open + ".cup.txt", unique_list_finished)
...
def main():
    ...
    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "cup.cfg"))
...
def get_parser():
    ...
    to use"""
    parser = argparse.ArgumentParser(description="Common User Passwords")
